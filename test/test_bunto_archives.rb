...
class TestBuntoArchives < Minitest::Test
  context "the bunto-archives plugin" do
    setup do
      @site = fixture_site({
        "bunto-archives" => {
          "enabled" => true
      ...
      @site.read
      @archives = Bunto::Archives::Archives.new(@site.config)
    end
  ...
  context "the bunto-archives plugin with custom layout path" do
    setup do
      @site = fixture_site({
        "bunto-archives" => {
          "layout" => "archive-too",
  ...
  context "the bunto-archives plugin with type-specific layout" do
    setup do
      @site = fixture_site({
        "bunto-archives" => {
          "enabled" => true,
  ...
  context "the bunto-archives plugin with custom permalinks" do
    setup do
      @site = fixture_site({
        "bunto-archives" => {
          "enabled" => true,
  ...
  context "the bunto-archives plugin with default config" do
    setup do
      @site = fixture_site
      @site.process
    end
  ...
  context "the bunto-archives plugin with enabled array" do
    setup do
      @site = fixture_site({
        "bunto-archives" => {
          "enabled" => ["tags"]
